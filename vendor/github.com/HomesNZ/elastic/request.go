...
// SetAuthorizationHeader sets the Authorization HTTP header of the request
func (r *Request) SetAuthorizationHeader(authorization string) {
	((*http.Request)(r)).Header.Set("Authorization", authorization)
}
